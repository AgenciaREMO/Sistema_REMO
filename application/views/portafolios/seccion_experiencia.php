        ...
        <?php 
            ...
            { 
				if($checkExperiencia == $fila->id_img){
                    $radioImg = array('name'=>'id_img','id'=>'id_img','value'=>''.$fila->id_img.'','type'=>'checkbox','disabled'=>'disabled','checked'=>TRUE);
                }else{
                    $radioImg = array('name'=>'id_img','id'=>'id_img','value'=>''.$fila->id_img.'','type'=>'checkbox','disabled'=>'disabled','checked'=>FALSE);
                }
				//botones
