  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <ul class="nav nav-pills" >
          ...
          <li role="presentation"><a href="<?= base_url('portafolios/c_equipo/cargarEquipo').'/'.$id_portafolio ?>">Equipo de trabajo</a></li>
          <li role="presentation"><a href="<?= base_url('portafolios/c_experiencia/cargarExperiencia').'/'.$id_portafolio ?>">Experiencia</a></li>
          <li role="presentation"><a href="<?= base_url('portafolios/c_grafico/cargarGrafico').'/'.$id_portafolio ?>">Portafolio</a></li>
