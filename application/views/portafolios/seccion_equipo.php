                            ...
                            if($id_portafolioP == '' OR $id_portafolioP == NULL OR $id_portafolioP != $id_portafolio){
                                ?>
                                  <tr>
                                    ...
                                    <td><?= $nombre ?></td> 
                                    <td><?= $puesto ?></td>
                                    <td><div class="checkbox" style="text-align:center"><?= form_checkbox("id_personal[]", ''.$id_personalP.'', set_checkbox("id_personal[]", ''.$id_personalP.'', FALSE)); ?></div></td>
                                    <td><div class="checkbox" style="text-align:center"><?= form_checkbox("destacado[]", ''.$destacado.'', set_checkbox("destacado[]", ''.$destacado.'', FALSE)); ?></div></td>
                                  </tr>
                                <?php
                            }else{
                              if (!empty($id_portafolioP) AND !empty($id_personalP) AND empty($destacado)) {
                                ?>
                                  <tr>
                                    ...
                                    <td><?= $nombre ?></td> 
                                    <td><?= $puesto ?></td>
                                    <td><div class="checkbox" style="text-align:center"><?= form_checkbox("id_personal[]", ''.$id_personalP.'', set_checkbox("id_personal[]", ''.$id_personalP.'', TRUE)); ?></div></td>
                                    <td><div class="checkbox" style="text-align:center"><?= form_checkbox("destacado[]", ''.$destacado.'', set_checkbox("destacado[]", ''.$destacado.'', FALSE)); ?></div></td>
                                  </tr>
                                <?php
                              }else{
                                if (!empty($id_portafolioP) AND !empty($id_personalP) AND !empty($destacado)) {
                                  ?>
                                    <tr>
                                      ...
                                      <td><?= $puesto ?></td>
                                      <td><div class="checkbox" style="text-align:center"><?= form_checkbox("id_personal[]", ''.$id_personalP.'', set_checkbox("id_personal[]", ''.$id_personalP.'', TRUE)); ?></div></td>
                                      <td><div class="checkbox" style="text-align:center"><?= form_checkbox("destacado[]", ''.$destacado.'', set_checkbox("destacado[]", ''.$destacado.'', TRUE)); ?></div></td>
                                    </tr>
                                  <?php
                                }
                              }
